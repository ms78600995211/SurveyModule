                            ...
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        ...
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="CountriesController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                                            <div class="custom-select" class="form-control"     style="width:100%; border:  1px  solid #ccc ;border-radius:5px">
                                                                <select class="form-control" id="dropdown" name="country_id" size="1" >
                                                                    <option value="" selected disabled>Select One</option>
                                                                    <option value="" selected>All</option>
                                                                    <c:forEach var="option" items="${allCountries}">
                                                                        <option value="${option.country_id}" ${option.country_id eq requestScope.country_Id ? 'selected' : ''}>${option.country_name}</option>
                                                                    </c:forEach>
                                                                </select> 
                                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Add Countries</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="countries" items="${requestScope['CountriesAllData']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${countries.country_name}</p>
                                                                    </td>
                                                                    <td>${countries.continent_name}</td>
                                                                    <td>${countries.remark}</td>
                                                                    <td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Countries Add</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="CountriesController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Country Name<span class="text-danger">*</span> </label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">continents<span class="text-danger">*</span></label>
                                        <select class="form-control" name="continentId" id="continentId" required>
                                            <option value="" selected disabled>---Select One---</option>
                                            <c:forEach var="continent" items="${requestScope['ContinentData']}"
                                                       varStatus="loopCounter">
                                                <option id ="${continent.continent_name}" value="${continent.continent_id}" >${continent.continent_name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
