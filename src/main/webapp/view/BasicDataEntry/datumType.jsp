            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Datum Type</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                                <li class="breadcrumb-item active">Datum Type</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        ...
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="DatumTypeController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Add Datum Type</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="datumType" items="${requestScope['DatumTypeAllData']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${datumType.datumType_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${datumType.remark}</p>
                                                                    </td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Datum Type Add</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="DatumTypeController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Datum Type<span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" name="datumType"
                                               placeholder="datumType" required>
                                    </div>
                                </div>
