            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">PDA Params</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">PDA Params</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        ...
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="PDAParamsController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> PDA Params</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="PDAParams" items="${requestScope['getPDAParams']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.pdaparams_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.IP}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.portNo}</p>
                                                                    </td>

                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.url}</p>
                                                                    </td>

                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.username}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.passwd}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.defaultConfig}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.mountPoint}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${PDAParams.remark}</p>
                                                                    </td>
                                                                    <td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">PDA Params</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="PDAParamsController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Port No. </label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Mount Point</label>
