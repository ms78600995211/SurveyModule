            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Project Status</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        <p class="text-muted mb-2">Select Project Status</p>
                                        <div class="row">                
                                            <div class="col-md-8">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Add Project Status</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
...
<!--                                                                <th>Status Type</th>-->
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="projectStatus" items="${requestScope['ProjectStatusAllData']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${projectStatus.status}</p>
                                                                    </td>
                                                                    <td>${projectStatus.description}</td>
<!--                                                                    <td>${projectStatus.status_type}</td>-->
                                                                    <td>${projectStatus.remark}</td>
                                                                    <td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="ProjectStatusController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Project Status<span class="text-danger">*</span> </label>
...
<!--                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Status Type<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="projectStatusDescription"
