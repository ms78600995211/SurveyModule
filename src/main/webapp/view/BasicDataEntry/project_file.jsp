...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Project File</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                                <li class="breadcrumb-item active">Project File</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        <p class="text-muted mb-2">Search Project</p>
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="ProjectFileController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                                            <div class="custom-select" class="form-control"     style="width:100%; border:  1px  solid #ccc ;border-radius:5px">
                                                                <select class="form-control" id="dropdown" name="project_id" size="1" >
                                                                    <option value="" selected disabled>Select One</option>
                                                                    <option value="" selected>All</option>
                                                                    <c:forEach var="option" items="${getAllProjectDetails}">
                                                                        <option value="${option.project_details_id}" ${option.project_details_id eq requestScope.projectId ? 'selected' : ''}>${option.project_name}</option>
                                                                    </c:forEach>
                                                                </select> 
                                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Add Project File</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="projectfile" items="${requestScope['allProjectFile']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${projectfile.file_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${projectfile.folder_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${projectfile.project_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <button onclick="downloadFile(${projectfile.project_file_id})" name="submitviewFile" value="OpenFile" class="btn btn-primary">View File</button>
                                                                        <!--                                                                        <button class="btn btn-primary" type="submit" name="submitFormBtn" value="Submit">Submit form</button>-->

                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${projectfile.remark}</p>
                                                                    </td>
                                                                    <td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Add Project File</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="ProjectFileController" method="post"  enctype="multipart/form-data">
                            <div class="row">                      
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        <label for="projectfile">Select File</label>
    ...
    <script>
                                                                            ...
                                                                            function downloadFile(fileName) {
                                                                                window.location.href = 'ProjectFileController?fileId=' + fileName;
                                                                            }
