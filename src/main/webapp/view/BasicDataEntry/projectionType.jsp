            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Projection Type</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                                <li class="breadcrumb-item active">Projection Type</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        <p class="text-muted mb-2">Select Projection Type</p>
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="ProjectionTypeController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                                            <div class="custom-select" class="form-control"     style="width:100%; border:  1px  solid #ccc ;border-radius:5px">
                                                                <select class="form-control" id="dropdown" name="projectiontype_id" size="1" >
                                                                    <option value="" selected disabled>Select One</option>
                                                                    <option value="" selected>All</option>
                                                                    <c:forEach var="option" items="${projectionTypeList}">
                                                                        <option value="${option.projectiontype_id}" ${option.projectiontype_id eq requestScope.projectionTypeId ? 'selected' : ''}>${option.projectionType}</option>
                                                                    </c:forEach>
                                                                </select> 
                                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i>Add ProjectionType</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="projectionType" items="${requestScope['ProjectionTypeAllData']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${projectionType.projectionType}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${projectionType.remark}</p>
                                                                    </td>
                                                                    <td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Add ProjectionType</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="ProjectionTypeController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Projection Type<span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" name="projectionType"
                                               placeholder="ProjectionType" required>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
