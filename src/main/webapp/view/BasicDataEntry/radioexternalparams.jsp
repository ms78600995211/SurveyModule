            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Radio External Params</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                                <li class="breadcrumb-item active">Radio External Params</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        ...
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="RadioExternalParamsController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i>Radio External Params</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="radioexternalparams" items="${requestScope['list']}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td> <p class="mb-0">${radioexternalparams.radioexternalparams_name}</p></td>
                                                                    <td> <p class="mb-0">${radioexternalparams.baudrate}</p></td>
                                                                    <td> <p class="mb-0">${radioexternalparams.power}</p></td>
                                                                    <td> <p class="mb-0">${radioexternalparams.protocol}</p></td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Radio External Params</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="RadioExternalParamsController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Baud Rate<span class="text-danger">*</span> </label>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Protocol<span class="text-danger"></span> </label>
