            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">	
                        <h4 class="mb-sm-0 font-size-18">Project Configuration Main Mapping</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Project Configuration Main Mapping</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Project Configuration Main Mapping</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                                    ...
                                                    <table id="datatable"  class="table table-bordered dt-responsive  nowrap w-100"  >
                                                        <thead>
                                                            <tr>
                                                                <th>Sr.</th>
                                                                <th>Project Name</th>
                                                                <th>Project Config Mapping</th>
                                                                <th>Remarks</th>
                                                                <th></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <c:forEach var="ProjectConfigurationMainMapping" items="${requestScope['getAllProjectConfigurationMainMapping']}" varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${ProjectConfigurationMainMapping.project_name}</p>
                                                                    </td>
                                                                   <td>
                                                                        <p class="mb-0">${ProjectConfigurationMainMapping.project_configuration_mapping_name}</p>
                                                                    </td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Project Configuration Main Mapping</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="ProjectConfigurationMainMappingController" method="post">
                            <div class="row">  
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control"  name="project_details_id" id="project_details_id" required>
                                            <option value="" selected disabled>Select One</option>
                                            <c:forEach var="ProjectDetails" items="${requestScope['getProjectDetailsList']}"
                                                       varStatus="loopCounter">
                                                <option value="${ProjectDetails.project_details_id}" >${ProjectDetails.project_name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Project Configuration Mapping<span class="text-danger">*</span></label>
