                            ...
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        ...
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="SatelliteConfigurationController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                                            <div class="custom-select" class="form-control"     style="width:100%; border:  1px  solid #ccc ;border-radius:5px">
                                                                <select class="form-control" id="dropdown" name="satelliteConfigurationName" size="1" >
                                                                    <option value="" selected disabled>Select One</option>
                                                                    <option value="" selected>All</option>
                                                                    <c:forEach var="option" items="${allSatelliteConfig}">
                                                                        <option value="${option}" ${option eq requestScope.satelliteConfigurationName ? 'selected' : ''}>${option}</option>
                                                                    </c:forEach>
                                                                </select> 
                                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Satellite Configuration </button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable"  class="table table-bordered dt-responsive  nowrap w-100"  >
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="SatelliteConfig" items="${requestScope['getSatelliteConfigList']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${SatelliteConfig.satellite_configuration_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${SatelliteConfig.defaultConfig}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${SatelliteConfig.remark}</p>
                                                                    </td>    
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Satellite Configuration </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="SatelliteConfigurationController" method="post">
                            <div class="row">  

                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Satellite Configuration Name<span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" name="satellite_configuration_name"
                                               placeholder="Satellite Configuration Name" required="">
                                    </div>
                                </div>
