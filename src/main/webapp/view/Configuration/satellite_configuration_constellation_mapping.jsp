            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">	
                        <h4 class="mb-sm-0 font-size-18">Satellite Configuration</h4>
                            ...
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        ...
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="SatelliteConfigurationConstellationMappingController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                                            <div class="custom-select" class="form-control"     style="width:100%; border:  1px  solid #ccc ;border-radius:5px">
                                                                <select class="form-control" id="dropdown" name="satellite_configurationId" size="1" >
                                                                    <option value="" selected disabled>Select One</option>
                                                                    <option value="" selected>All</option>
                                                                    <c:forEach var="option" items="${allSatellite_configuration}">
                                                                        <option value="${option.satellite_configuration_id}" ${option.satellite_configuration_id eq requestScope.satellite_configurationId ? 'selected' : ''}>${option.satellite_configuration_name}</option>
                                                                    </c:forEach>
                                                                </select> 
                                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Satellite Configuration Constellation Mapping</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                                ...
                                                <div class="col-12">
                                                    <table id="datatable"  class="table table-bordered dt-responsive  nowrap w-100"  >
                                                        <thead>
                                                            <tr>
                                                                <th>Sr.</th>
                                                                <th>Satellite Configuration Name</th>
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="SatelliteConfigConstnMapping" items="${requestScope['getSatelliteConfigConstnMappingList']}" varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${SatelliteConfigConstnMapping.satellite_configuration_name}</p>
                                                                    </td>
                                                                    <td>

                                                                        <select class="form-control"  name="satellite_configuration_id" id="satellite_configuration_id"  multiple="multiple" required multiple size="3">
                                                                            <c:forEach var="constellation" items="${SatelliteConfigConstnMapping.all_constellation}"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Satellite Configuration Constellation Mapping</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="SatelliteConfigurationConstellationMappingController" method="post">
                            <div class="row">  

                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label class="form-label">Select Satellite Configuration Name<span class="text-danger">*</span></label>

                                        <select class="form-control"  name="satellite_configuration_id" id="satellite_configuration_id" required>
                                            <option value="" selected disabled>Select One</option>
                                            <c:forEach var="Satellite_configuration" items="${requestScope['getSatellite_configurationList']}"
                                                       varStatus="loopCounter">
                                                <option id ="${Satellite_configuration.satellite_configuration_id}" value="${Satellite_configuration.satellite_configuration_id}" >${Satellite_configuration.satellite_configuration_name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <!--                                <div class="col-md-3">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Select Constellation Name<span class="text-danger">*</span></label>
                                
                                                                         "Select All" checkbox 
                                                                        <div class="form-check">
                                                                            <input type="checkbox" class="form-check-input" id="selectAllConstellations">
                                                                            <label class="form-check-label" for="selectAllConstellations">Select All</label>
                                                                        </div>
                                
                                                                         Multiple-select dropdown 
                                                                        <select class="form-control custom-width" name="constellation_id" id="constellation_id" required multiple size="3">
                                <c:forEach var="Constellation" items="${requestScope['getConstellationList']}" varStatus="loopCounter">
                                    <option id="${Constellation.constellation_id}" value="${Constellation.constellation_id}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="multiselect">
                                            <div class="selectBox" onclick="showCheckboxes()">
                                                <select  class="form-control"  id="dropdown" name="constellation_id">
                                            ...
                                            <div id="checkboxes">
                                                <label>
                                                    <input type="checkbox" id="selectAll" onclick="selectsAll()"> Select All
                                                </label>

                                                <c:forEach var="constellation" items="${requestScope['getConstellationList']}" varStatus="loopCounter">
                                                    <label class="form-check" for="checkbox_${constellation.constellation_id}">
                                                        <input type="checkbox" name="${constellation.constellation_name}" id="checkbox_${constellation.constellation_id}"   />
                                                        ${constellation.constellation_name}
                                                    </label>
                                                </c:forEach>
                                            </div>
