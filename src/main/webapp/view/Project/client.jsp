                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"  disabled=""> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Client</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="client" items="${requestScope['clientList']}"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p class="mb-0">${client.org_office_name}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${client.key_person_name}</p>
                                                                    </td>
                                                                   
                                                                    <td>
                                                                        <p class="mb-0">${client.designation}</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">${client.mobile_no}</p>
                                                                    </td> 
                                                                    <td>
                                                                        <p class="mb-0">${client.email_id}</p>
                                                                    </td>
                                                                     <td>
                                                                        <p class="mb-0">${client.city_name}</p>
                                                                    </td>
