...
<div class="main-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Client Base Rover Registration Map</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Client Base Rover Registration Map</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="mb-3">
                                                                <select class="form-control" name="District">
                                                                    ...
                                                                    <option value="#">AngleUnit1</option>
                                                                    <option value="#">AngleUnit2 </option>
                                                                    <option value="#">AngleUnit3</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Client Base Rover Registration Map</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Client Base Rover Registration Map</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="ClientBaseRoverRegistrationMappingController" method="post">
                            <div class="row">                      
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control"  name="client_registeration_id" id="client_registeration_id"  onchange="getClientName(this.value)" required>
                                            ...
                                            <c:forEach var="client" items="${requestScope['client_details']}"
                                                       varStatus="loopCounter">
                                                <option id ="${client.client_registeration_id}" value="${client.client_registeration_id}" >${client.client_name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function getClientName(value) {
            $.ajax({
                url: "ClientBaseRoverRegistrationMappingController",
                data: "task=validateDevices&client_registeration_id=" + value,
                type: 'POST',
                dataType: 'json',
                success: function (response) {
                    ...
                    for (var i = 0; i < rover_details.length; i++) {
                        ...
                        var newInput1 = '<option id="' + rover_details[i].ntrip_rover_id + '" value="' + rover_details[i].ntrip_rover_id + '" class="docDetails">' + rover_details[i].rover_name + '</option>';
                        console.log(newInput1);

                        $('#ntrip_rover_id').append(newInput1);
                    }
