            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Column SubType</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Column SubType</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl-Add-Enquiry"> <i class="bx bx-plus font-size-16 align-middle me-2"></i>Add Column SubType</button>
                                                    </div>      
                                                </div>                        
                                            </div>
                                        </div>                            
                                                    ...
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                <th>Sr.</th>
                                                                <th>Column Type</th>
                                                                <th>Column SubType</th>
                                                                <th>Remark</th>
                                                                <th></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody> 
                                                            <c:forEach var="subcolumntype" items="${requestScope['list']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td> <p class="mb-0">${subcolumntype.type_name}</p></td>
                                                                    <td> <p class="mb-0">${subcolumntype.subtype_name}</p></td>
                                                                    <td> <p class="mb-0">${subcolumntype.remark}</p></td>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Add Column SubType</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div>
                        <form class="custom-validation" action="ColumnSubTypeController" method="post">
                            <div class="row">   
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control"  name="column_type_id" id="column_type_id" required>
                                            <option value="" selected disabled>---Select One---</option>
                                            <c:forEach var="columntype" items="${requestScope['columntypeList']}"
                                                       varStatus="loopCounter">
                                                <option id ="${columntype.column_type_id}" value="${columntype.column_type_id}" >${columntype.type_name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Column SubType<span class="text-danger">*</span> </label>
                                        <input type="text" class="form-control" name="subtype_name"
                                               placeholder="Column SubType" required>
                                    </div>
                                </div>
