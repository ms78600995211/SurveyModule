            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Form Mapping</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                <li class="breadcrumb-item active">Form Mapping</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="px-3">
                                    <div class="mt-2">
                                        <p class="text-muted mb-2">Select Form Name</p>
                                        <div class="row">                
                                            <div class="col-md-8">
                                                <form method="post" action="FormMappingController">
                                                    <div class="row">  
                                                        <div class="col-md-3">
                                                            <div class="custom-select" class="form-control"  style="width:100%; border:  1px  solid #ccc ;border-radius:5px">
                                                                <select class="form-control" id="dropdown" name="formId" size="1" >
                                                                    ...
                                                                    <c:forEach var="option" items="${getAllForm}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5 text-end">
                                                        ...
                                                        <a  class="btn btn-primary waves-effect waves-light"  href="FormMappingController?task=addForm"> <i class="bx bx-plus font-size-16 align-middle me-2"></i> Add Form Mapping</a>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                                        ...
                                                        <tbody> 
                                                            <c:forEach var="formMapping" items="${requestScope['FormMappingAllData']}"
                                                                       varStatus="loopCounter">
                                                                <tr>
                                                                    <td>${loopCounter.count}</td>
                                                                    <td>
                                                                        <p class="mb-0">${formMapping.form_name}</p>
                                                                    </td>
                                                                    <td>${formMapping.display_name}</td>
                                                                    <td>${formMapping.type_name}</td>
                                                                    <td>${formMapping.subtype_name}</td>
                                                                    <td>${formMapping.is_selected}</td>
                                                                    <td>${formMapping.data_length}</td>
                                                                    <td>${formMapping.remark}</td>
                                                                    <td>
